...
$api_url = "https://api.rawg.io/api/games?key=48b96e3384384217854a2dd35e1e8f08&ordering=+rating&page=$page_number";
    ...
    <script>
        ...
        gameElements.forEach(function(gameElement, index) {
            gameElement.addEventListener('click', function() {
                ...
                var releaseDate = game.released || 'Fecha no disponible';
